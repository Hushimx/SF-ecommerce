...
@section('content')
 ...
 {{-- VENDOR PANEL ENDS --}}
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">Order placed*</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="orderplaced1" placeholder="show" required=""
                          value="{{ $lang->orderplaced1 }}">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">On review*</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="onreview1" placeholder="show" required=""
                          value="{{ $lang->onreview1 }}">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-4">
                      ...
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="ondelivery1" placeholder="show" required=""
                          value="{{ $lang->ondelivery1 }}">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">Delivered*</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="delivered1" placeholder="show" required=""
                        value="{{ $lang->delivered1 }}">
                      </div>
                    </div>
