        ...
        <div class="user-profile-details">
          <div class="order-details">
            ...
            <div class="view-order-page">
              <h3 class="order-code">{{ $langg->lang285 }} {{$order->order_number}} [@if($langg->rtl == "1")
                @if($order->status == "pending") في انتظار المراجعة @elseif($order->status == "processing") جاري معالجة
                الطلب @elseif($order->status == "completed") مكتمل
          ...
          <div class="billing-add-area">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                {{ $langg->lang295 }}
                <p>{{$order->charge_id}}</p>
                @endif @if($order->method=="مصرف الراجحي") {{ $langg->adapter_name }} :
                {{$order->adapter_name}}<br><br>{{ $langg->transfer_amount }} :
                {{$order->transfer_amount}}<br><br>{{ $langg->transfer_date }} : {{$order->transfer_date}}<br><br>
