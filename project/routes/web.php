...
Route::get('/shipping/get-city','Admin\ShippingController@getcity');
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/checkout/get-city','Front\CheckoutController@getcity');
  Route::get('/checkout/get-shipping-method','Front\CheckoutController@getshippingmethod');
