            ...
            <div class="col-lg-7">
              <div class="right-area">
                <div class="product-info">
                  ...
                  <div class="p_data" style="background-color: #ececec;">
                    <div class="container">
                      <div class="row">
                      ...
                      <li class="d-block count {{ $productt->type == 'License' ? '' : 'd-none' }}">
                        ...
                        <div class="info-meta-3">
                          <ul class="meta-list">
                            ...
                            @if($productt->type == 'normal')
                            <div class="info-meta-3">
                              <ul class="meta-list">
                                <li class="d-block count {{ $productt->type == 'normal' ? '' : 'd-none' }}">
                                  <div class="qty out-of-stock">
                                    <ul>
                                      <li>
                  ...
                  <div class="col-lg-12">
                    <div id="product-details-tab">
                      <div class="top-menu-area">
                        <ul class="tab-menu">
                        <li style="float: unset;"><a href="#tabs-1">{{ $langg->lang92 }}</a></li>
                          @if($productt->type == 'Physical')
                          <li style="float: unset;"><a href="#tabs-2">{{ $langg->lang93 }}</a></li>
                          @else
                          <li style="float: unset;"><a href="#tabs-5">{{ $langg->lang00099 }}</a></li>
                          @endif
                          <li style="float: unset;"><a href="#tabs-3">{{ $langg->lang94 }}({{ count($productt->ratings) }})</a></li>
                          @if($gs->is_comment == 1)
                          <li style="float: unset;"><a href="#tabs-4">{{ $langg->lang95 }}(<span
                      ...
                      <div class="tab-content-wrapper">
                        ...
                        @if($productt->type == 'Physical')
                          ...
                          <div id="tabs-5" class="tab-content-area">
                            @if($productt->platform == 'Steam')
                            <p><div><font color="#ff0000">اولاً </font>قم بتحميل منصة ستيم على جهازك</div><div><font color="#ff0000">ثانياً </font>قم بتسجيل دخول واذا لم يكن لديك حساب يمكنك انشاء حساب جديد</div><div><font color="#ff0000">ثالثاً </font>اضغط على Games المتواجدة في القائمة العلوية ثم اضغط على Activate a Product on Steam</div><div><br></div><div><img src="{{asset('assets/images/steamPic1_1.jpg')}}" alt="" align="none"><br></div><div><br></div><div><font color="#ff0000">رابعاً </font>قم بأدخال رمز اللعبة المرسل على بريدك الإلكتروني او من خلال صفحة الطلب في متجرنا</div><div><br></div><div><img src="{{asset('assets/images/steamPic2_2.jpg')}}" alt="" align="none"><br></div><div><br></div><div>وبعد ادخال الرمز اللعبة ستكون متاحة في مكتبة الألعاب الخاصة بك</div></p>
                            @elseif($productt->platform == 'Origin')
                            <p><div><font color="#ff0000">اولاً </font>تقوم بتحمل مشغل اورجن من موقعهم الرسمي <a href="https://www.origin.com/sau/en-us/store/download" title="" target="_blank">https://www.origin.com/sau/en-us/store/download</a></div><div><font color="#ff0000">ثانياً </font>تقوم بتسجيل دخولك في المنصة او تقوم بأنشاء حساب جديد في حال انه لم يكن لديك حساب</div><div><font color="#ff0000">ثالثاً </font>افتح قائمة اورجن واختار Redeem product code</div><div><br></div><div><img src="{{asset('assets/images/originPic1.jpg')}}" alt="" align="none"><br></div><div><br></div><div><font color="#ff0000">رابعاً </font>قم بأدخال رمز اللعبة المرسل على بريدك الإلكتروني او من خلال صفحة الطلب في متجرنا</div><div><br></div><div><img src="{{asset('assets/images/mceclip2.png')}}" alt="" align="none"><br></div><div><br></div><div>وبعد ادخال الرمز اللعبة ستكون متاحة في مكتبة الألعاب الخاصة بك</div><div><br></div></p>
                            @elseif($productt->platform == 'Rockstar')
                            <p><div><font color="#ff0000">اولاً </font>تقوم بتحمل مشغل روكستار من موقعهم الرسمي <a href="https://socialclub.rockstargames.com/rockstar-games-launcher" title="" target="_blank">https://socialclub.rockstargames.com/rockstar-games-launcher&nbsp;</a></div><div><br></div><div><font color="#ff0000">ثانياً </font>تقوم بستجيل دخولك في المنصة او تقوم بأنشاء حساب جديد في حال انه لم يكن لديك حساب</div><div><br></div><div><font color="#ff0000">ثالثاً </font>اضغط على صورة حسابك المتواجدة في اعلى اليمين واختار Redeem Code من القائمة</div><div><br></div><div><font size="2"><img src="{{asset('assets/images/SC104.png')}}" alt="" align="none"></font><br></div><div><br></div><div><img><font color="#ff0000">رابعاً </font>قم بأدخال رمز اللعبة المرسل على بريدك الإلكتروني او من خلال صفحة الطلب في متجرنا<br></div><div><br></div><div>وبعد ادخال الرمز اللعبة ستكون متاحة في مكتبة الألعاب الخاصة بك</div><div><br></div></p>
                         @endif
                          </div>
                          @endif
                                ...
                                <div class="star-area">
                                  <ul class="star-list">
                                    <fieldset class="rating">
                                      <input type="radio" name="rating" id="star5" value="5" /><label class="full"
                                        for="star5" title="Awesome - 5 stars"></label>
                                      <input type="radio" name="rating" id="star4" value="4" /><label class="full"
                                        for="star4" title="Pretty good - 4 stars"></label>
                                      <input type="radio" name="rating" id="star3" value="3" /><label class="full"
                                        for="star3" title="Meh - 3 stars"></label>
                                      <input type="radio" name="rating" id="star2" value="2" /><label class="full"
                                        for="star2" title="Kinda bad - 2 stars"></label>
                                      <input type="radio" name="rating" id="star1" value="1" /><label class="full"
