    ...
    <div class="row">
                ...
                <div class="content-box">
                  <div class="content">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input class="form-control ship_input" type="text" name="shipping_phone"
                            ...
                            >
                            <p class="text-danger text-right" id="shipp-phone-error"></p>  
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-6">
                      ...
                      <div class="row mt-2">
                        <div class="col-lg-6">
                          ...
                          <input class="form-control ship_input" type="text" name="shipping_address"
                            ...
                            <p class="text-danger text-right" id="address-error" ></p>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                      <div class="col-lg-12 mt-3">
                        <div class="bottom-area text-center">
                          <a href="javascript:;" id="step2-btn" class="btn mybtn2">{{ $langg->lang757 }}</a>
                      ...
                      <div class="row mt-2">
                        <div class="col-lg-6">
                          ...
                          <input class="form-control ship_input" type="text" name="shipping_address"
                            id="shipping_address" placeholder="{{ $langg->lang155 }}"
                            value="{{ Auth::guard('web')->check() ? Auth::guard('web')->user()->address : '' }}">
                            <p class="text-danger text-right" id="shipp-address-error"></p>
                        </div>
                  ...
                  <div class="content">
                    ...
                    <div class="row">
                      <div class="col-lg-12 mt-3">
                        <div class="bottom-area text-center">
                          @if ($digital == 0)
                          <a href="javascript:;" id="step5-btn" class="btn mybtn2">{{ $langg->lang757 }}</a>
                          @else
                          <a href="javascript:;" id="step6-btn" class="btn mybtn2">{{ $langg->lang757 }}</a>
                          @endif
      ...
      <div class="col-lg-4">
        <div class="right-area" style="position: fixed; width: 284px;">
          <div class="order-box">
            <h4 class="title"><i class="bi bi-box-seam"></i> {{ $langg->lang127 }}</h4>
            <ul class="order-list">
              <li>
                <p>
                  {{ $langg->lang128 }}
            ...
            <div class="cupon-box">
              ...
              <form id="check-coupon-form" class="coupon">
                <input type="text" placeholder="{{ $langg->lang133 }}" id="code" autocomplete="off"><br>
...
$('#step3-btn').on('click', function() {
  ...
  var customeraddress = $('#shipping_address').val() ;
  var dp = $("#dp").val();

  console.log(customerCountry);


  if ($('#shipping_address').val() == null || $('#shipping_address').val() == "" ) {
    $('#shipp-address-error').fadeIn() ;
    $('#shipp-address-error').text("!الرجاء تحديد العنوان");
  }
  if ($('#shipingPhone_number').val() == null || $('#shipingPhone_number').val() == "") {
    $('#shipp-phone-error').fadeIn() ;
    $('#shipp-phone-error').text("!الرجاء تحديد رقم الهاتف");
  }

  else if ( $('#shipping_address').val() != "" ) {
    $('#shipp-address-error').fadeOut() ;;
  }
  else if ($('#shipingPhone_number').val() != "") {
    $('#shipp-phone-error').fadeOut() ;
  }
  ...
  if (customerCountry == '0' || customerCountry == null) {
    ...
    if (customerCity == '0' || customerCity == null) {
      ...
      if (customeraddress == "") {
         $('#address-error').text("!الرجاء تحديد العنوان");
     } else {
      if ($('#shipingPhone_number').val() == null || $('#shipingPhone_number').val() == "") {
           $('#shipp-phone-error').fadeIn() ;
          $('#shipp-phone-error').text("!الرجاء تحديد رقم الهاتف");
