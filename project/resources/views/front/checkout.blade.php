									...
									<div class="content">
										...
										<div class="billing-address">
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<input class="form-control" type="text" name="name" placeholder="{{ $langg->lang152 }}" required="" value="{{ Auth::guard('web')->check() ? Auth::guard('web')->user()->name : '' }}" {!! Auth::check() ? 'readonly' : '' !!}>
												</div>
												<div class="col-lg-6">
												...
												<div class="col-lg-6">
													<input class="form-control" type="text" name="email" placeholder="{{ $langg->lang154 }}" required="" value="{{ Auth::guard('web')->check() ? Auth::guard('web')->user()->email : '' }}" {!! Auth::check() ? 'readonly' : '' !!}>
												</div>
												<div class="col-lg-6">
										...
										<div class="ship-diff-addres-area d-none">
											...
											<div class="row">
												<div class="col-lg-6">
													<input class="form-control ship_input" type="email" name="shipping_email" id="ship_email" placeholder="{{ $langg->lang154 }}">
												</div>
												<div class="col-lg-6">
											...
											<div class="row">
												<div class="col-lg-12">
													<div class="nav flex-column" role="tablist" aria-orientation="vertical">
														...
														<a class="nav-link payment active" data-show="no" data-form="{{route('paypal.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'paypal','slug2' => 0]) }}" id="v-pills-tab1-tab" data-toggle="pill" href="#v-pills-tab1" role="tab" aria-controls="v-pills-tab1" aria-selected="true">
															<div class="icon">
														...
														@endif
														<a class="nav-link payment " data-show="no" data-form="{{route('paylink.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'paylink','slug2' => 0]) }}" id="v-pills-tab0-tab" data-toggle="pill" href="#v-pills-tab0" role="tab" aria-controls="v-pills-tab0" aria-selected="true">
															<div class="icon">
																<span class="radio"></span>
															</div>
															<p>
