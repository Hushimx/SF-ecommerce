			...
			<div class="container">
					<div class="row">
						<div class="col-lg-4 remove-padding">
							<div class="left">
								<a class="banner-effect" href="{{ $top_small_banners->chunk(2)[0][0]->link }}" target="_blank">
									<img src="{{asset('assets/images/banners/img2.png')}}" alt="" style="height: 600px;">
								</a>
							</div>
						</div>
						<div class="col-lg-4 remove-padding">
							<div class="row">
								<div class="left">
								<a class="banner-effect" href="{{ $top_small_banners->chunk(2)[0][0]->link }}" target="_blank">
									<img src="{{asset('assets/images/banners/'.$top_small_banners->chunk(2)[0][0]->photo)}}" alt="">
								</a>
							</div>
							</div>
							<div class="row">
								<div class="left">
								<a class="banner-effect" href="{{ $top_small_banners->chunk(2)[0][1]->link }}" target="_blank">
									<img src="{{asset('assets/images/banners/'.$top_small_banners->chunk(2)[0][1]->photo)}}" alt="">
								</a>
							</div>
							</div>
							<div class="row">
						...
						<div class="col-lg-4 remove-padding">
							<div class="left">
								<a class="banner-effect" href="{{ $img->link }}" target="_blank">
									<img src="{{asset('assets/images/banners/img1.png')}}" alt="" style="height: 600px;">
								</a>
							</div>
						</div>
					</div>
		...
		<section class="banner-section">
			<div class="container">
					<div class="row">
						<div class="col-lg-4 remove-padding">
							<div class="left">
								<a class="banner-effect" href="http://ksvxhg.tk/category/PCg" target="_blank">
									<img src="{{asset('assets/images/banners/img2.png')}}" alt="" style="height: 600px;">
								</a>
							</div>
						</div>
						<div class="col-lg-4 remove-padding">
							<div class="row">
								<div class="left">
								<a class="banner-effect" href="http://ksvxhg.tk/category/software" target="_blank">
									<img src="{{asset('assets/images/banners/3.png')}}" alt="">
								</a>
							</div>
							</div>
							<div class="row">
								<div class="left">
								<a class="banner-effect" href="http://ksvxhg.tk/category/gs" target="_blank">
									<img src="{{asset('assets/images/banners/2.png')}}" alt="">
								</a>
							</div>
							</div>
							<div class="row">
								<div class="left">
								<a class="banner-effect" href="http://ksvxhg.tk/category/xboxg" target="_blank">
									<img src="{{asset('assets/images/banners/1.png')}}" alt="">
								</a>
							</div>
							</div>
						...
						<div class="col-lg-4 remove-padding">
							<div class="left">
								<a class="banner-effect" href="http://ksvxhg.tk/category/psngames" target="_blank">
									<img src="{{asset('assets/images/banners/img1.png')}}" alt="" style="height: 600px;">
								</a>
							</div>
						</div>
