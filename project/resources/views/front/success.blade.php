...
<style>
  .suc-p {font-size: 55px;background-color: rgb(67, 214, 116 , 0.2);color:  rgb(0, 160, 53) ;width: 120px;height: 120px;
  border-radius: 100%;line-height: 120px;text-align: center;margin: 20px 0;
  }
</style>
      ...
      <div class="col-lg-10">
        ...
        <div class="content-box section-padding add-product-1">
          <div class="top-area">
            <div class="content">
              <center>
              <div class="suc-p"><i class="bi bi-check2-circle"></i></div>
              </center>
              <h4 class="heading" style="margin: 8px 0;">
                {{ $langg->order_title }}
              </h4>
              <p class="text" style="margin: 8px 0;">
                {{ $langg->order_text }}
              </p>
              <a style="text-decoration: none;margin: 8px 0;" href="{{route('user-order',$order->id)}}" class="link btn btn-primary">{{ $langg->lang170 }}</a>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="dashboard-content">
                      <div class="view-order-page" id="print">
                        ...
                        <div class="table-responsive">
                          @if($langg->rtl == "0")
                           <table class="table" style="direction: ltr !important;">
                          @else
    ...
    <div class="row justify-content-center">
      <div class="col-lg-10">
        ...
        <div class="content-box section-padding add-product-1">
          <div class="top-area">
            <div class="content">
               <i class="fas fa-exclamation-triangle text-danger" style="font-size: 165px;margin-bottom: 24px;"></i>
