...
@else
			...
			<div class="container">
					<div class="row text-center m-0">
						<div class="col-lg-4 remove-padding">
							<div class="left">
								<a class="banner-effect" href="https://www.soft-fire.com/category/PCg" target="_blank">
									<img src="{{asset('assets/images/banners/SF-SIDE-BANNERpc.png')}}" alt="" style="height: 600px;">
								</a>
							</div>
						</div>
						<div class="col-lg-4 remove-padding">
							<div class="row m-0">
								<div class="left">
								<a class="banner-effect" href="https://www.soft-fire.com/category/gs" target="_blank">
									<img src="{{asset('assets/images/banners/first.png')}}" alt="" style="width: 382px;">
								</a>
							</div>
							</div>
							<div class="row m-0">
								<div class="left">
								<a class="banner-effect" href="https://www.soft-fire.com/category/xboxg" target="_blank">
									<img src="{{asset('assets/images/banners/second.png')}}" alt="" style="width: 382px;">
								</a>
							</div>
							</div>
							<div class="row m-0">
								<div class="left">
								<a class="banner-effect" href="https://www.soft-fire.com/category/software" target="_blank">
									<img src="{{asset('assets/images/banners/third.png')}}" alt="" style="width: 382px;">
								</a>
							</div>
							</div>
						...
						<div class="col-lg-4 remove-padding">
							<div class="left">
								<a class="banner-effect" href="https://www.soft-fire.com/category/psngames" target="_blank">
									<img src="{{asset('assets/images/banners/SF-SIDE-BANNERps.png')}}" alt="" style="height: 600px;">
								</a>
							</div>
						</div>
					</div>
	...
	@if($ps->best == 1)
		...
		<section class="phone-and-accessories categori-item trending">
			<div class="container">
				<div class="row">
				...
				<div class="row">
					<div class="trending-item-slider owl-carousel owl-theme owl-loaded owl2">
