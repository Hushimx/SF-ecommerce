...
class PaymentController extends Controller
{
    ...
    public function notify(Request $request)
    {
        ...
        if($gs->is_smtp == 1)
        {
            ...
            $prod44 = "";
            $prod45 = '<table class="all t"><thead><tr class="all hd"><th class="all hd">المجموع النهائي:</th><th class="all hd">'. $this->curr->sign . round($request->total,2).'</th></tr></thead></table></h5>';
