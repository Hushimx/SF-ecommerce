											...
											<div class="payment-information">
												...
												<div class="row">
													<div class="col-lg-12">
														...
														<a class="nav-link payment actived" data-show="no" data-form="{{route('paylink.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'paylink','slug2' => 0]) }}" id="v-pills-tab0-tab" data-toggle="pill" href="#v-pills-tab0" role="tab" aria-controls="v-pills-tab0" aria-selected="true">
															<div class="icon">
