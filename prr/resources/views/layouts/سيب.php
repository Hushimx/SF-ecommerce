	...
	<section class="logo-header">
		...
		<div class="container">
			...
			<div class="row ">
				...
				<div class="helpfullinks col-lg-2 col-sm-6 col-7 remove-padding order-lg-last">

					<div class="helpful-links">

						<ul class="helpful-links-inner">

							<li class="my-dropdown wishre-fix wishreho1">
							...
							<li class="wishlist">
								@if(Auth::guard('web')->check())
									...
									<a href="{{ route('user-wishlists') }}" role="button" class="wish">
								...
								@else
									...
									<a href="javascript:;" role="button" data-toggle="modal" id="wish-btn" data-target="#comment-log-reg" class="wish">
